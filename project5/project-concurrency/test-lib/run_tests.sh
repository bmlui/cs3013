...
print_error_message () {
    ...
    echo "  prompt> diff "$PARTDIR"$testdir/$testnum.$filetype "$PARTDIR"tests-out/$testnum.$filetype"
    echo "  here are the contents of "$PARTDIR"tests-out/$testnum.err"
    echo ""
    cat ./tests-out/$testnum.err 
